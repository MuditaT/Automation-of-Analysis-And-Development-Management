...
<h5><p id="suc"> YOUR QUERY HAS BEEN SUCCESSFULLY SUBMITTED<br>CLICK ON THE SUBMIT BUTTON TO SEE THE STATUS</p></h5>
<form id="form3" action="manager.php" method="post">
<input type="submit">
</form>
